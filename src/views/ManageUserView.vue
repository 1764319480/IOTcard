                    ...
                    <el-dialog v-model="centerDialogVisible" title="添加用户" width="400" align-center>
                        <div class="account_form">
                            <div>
                                ...
                                <el-input v-model="new_account" style="width: 200px" placeholder="请输入账号" clearable />
                            </div>
                            <div>
                                <div>
                                    <p>*</p>
                                ...
                                <el-input v-model="new_userName" style="width: 200px" placeholder="请输入用户名" clearable />
                            </div>
                            <div>
                                <div>
                                    <p>*</p>
                                ...
                                <el-input v-model="new_role" style="width: 200px" placeholder="请选择角色" clearable />
                            </div>
                            <div>
                                <div>
                                    <p>*</p>
                                ...
                                <el-input v-model="fix_pwd" style="width: 200px" placeholder="Please input" disabled />
                            </div>
                        </div>
                        <template #footer>
        ...
        <div class="lists">
            ...
            <template v-for="(item) in userList" :key="item.id">
                <div>
                    ...
                    <div><el-switch inline-prompt active-text="启用" inactive-text="禁用" v-model="item.statusParse" />
                    </div>
